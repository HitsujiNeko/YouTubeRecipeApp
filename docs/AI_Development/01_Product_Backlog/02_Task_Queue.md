...
| Q-001 | import | URL parser unit test実装 | todo | watch/shorts/youtu.be が通る | `11_Test_Plan_v3.md` |
| Q-002 | import | YouTube metadata client実装 | todo | timeout/retry付きでtitle取得 | `24_NFR_SLO_v1.md` |
| Q-003 | api | POST /api/recipes/import 実装 | todo | OpenAPI準拠で200/400/429/503を返す | `08_OpenAPI_v3.yaml`, `20_API_Error_Contract_v1.md`, `28_OpenAPI_Examples_v1.md` |
